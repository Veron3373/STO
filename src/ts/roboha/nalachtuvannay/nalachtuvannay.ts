...
const ROLE_SETTINGS = {
  ...
  Запчастист: [
    ...
    { id: 8, label: "Бухгалтерія 👨‍🔧 Зарплата" },
    { id: 9, label: "Бухгалтерія 👨‍🔧 Зарплата розраховувати💲" },
    { id: 10, label: "Бухгалтерія 👨‍🔧 Зарплата відміна розраховувати 💰" },
    ...
    { id: 14, label: "📋 Акт Зарплата 💲" },
    { id: 15, label: "📋 Акт Ціна та Сумма" },
    { id: 16, label: "📋 Акт Закриття акту 🗝️" },
...
    { id: 22, label: "📋 Акт ➕ Додати рядок" },
    { id: 23, label: "📋 Акт Видалити ⚙️ деталь або 🛠️ роботу" },
,
  ],
  Складовщик: [
    { id: 1, label: "Додати" },
...
    { id: 19, label: "📋 Акт ➕ Додати рядок" },
    { id: 20, label: "📋 Акт Видалити ⚙️ деталь або 🛠️ роботу" },
