...
/**
 * Оновлює індикатор номера ключа в хедері чату + завантажує токени з БД
 */
async function updateKeyIndicator(): Promise<void> {
  ...
  // Завантажуємо накопичені токени для поточного ключа з БД
 ...
 */
async function toggleKeyDropdown(): Promise<void> {
