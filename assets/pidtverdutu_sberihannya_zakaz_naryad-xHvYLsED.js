import{g as r,u as d}from"./main-BqRmUfXa.js";import"./supabaseClient-B08L58Py.js";const t="save-prompt-modal-create";function u(){const e=document.createElement("div");e.id=t,e.className="",e.style.display="none";const n=document.createElement("div");return n.className="modal-content-save-confirm",n.innerHTML=`
    <p>Зберегти зміни?</p>
    <div class="save-buttons">
      <button id="save-confirm" class="btn-save-confirm">Тааааак</button>
