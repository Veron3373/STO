...
const ROLE_SETTINGS = {
  Приймальник: [
    ...
    { id: 8, label: "Бухгалтерія 🏪 Склад" },
    { id: 9, label: "Бухгалтерія 🏪 Склад розраховувати💲" },
    { id: 10, label: "Бухгалтерія 🏪 Склад відміна розраховувати 💰" },
    { id: 11, label: "Бухгалтерія 🏪 Склад ↩️ повертати в магазин ⬅️🚚" },
    {
      id: 12,
